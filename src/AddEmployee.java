...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JButton add,back;
    JTextField tfname,tffname,tfaadhar,tfaddress,tfphone,tfemail,tfsalary,tfdesignation;
    JDateChooser dcdob;
    ...
    AddEmployee(){
        ...
        JLabel heading = new JLabel("New Employee Detail");
        ...
        JLabel labeleducation = new JLabel("Highest Edication");
        ...
        JLabel labeleaadhar = new JLabel("Aadhar Number");
        labeleaadhar.setBounds(400,350,150,30);
        labeleaadhar.setFont(new Font("serif",Font.PLAIN,20));
        add(labeleaadhar);
